...
<body class="bg-gray-200 fadeIn overflow-x-hidden max-w-full ">
  ...
  <main class="lg:mt-10 mt-5  ">
    <div class="lg:max-w-6xl m-5  lg:mx-auto">
      <div id="MainColor"
        ...
        <p class="font-light pt-2 mx-5 lg:mx-0  text-md  lg:text-2xl text-white lg:text-justify">
  ...
  <main class="mt-10 lg:mt-20 ">
    ...
    <p class="mx-5 mt-5 text-center text-lg lg:text-2xl leading-loose tracking-wide	">
    ...
    <div class="relative mt-20 lg:mx-20 mx-5">
      ...
      <div class=" bg-white flex justify-center mx-auto  absolute inset-x-0 -top-10 md:-top-12 lg:-top-12 w-28 h-28 rounded-full ">
        ...
        @csrf
        <div class="bg-white box-rounded2 shadow-xl lg:p-10 p-5 mt-7 flex flex-col justify-center">
          ...
          <div class="flex justify-center mt-8">
            <button id="bg-color-main"class="px-10 lg:px-14 py-3 rounded-full shadow-md 
